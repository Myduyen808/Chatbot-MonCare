...
def predict_intent(question, history=None):
    if history is None:
        history = []
...
# ===== CHẠY =====
c1, t1 = evaluate(test_cases, "TẬP RÕ RÀNG (28 câu: 7 câu mỗi lớp)")
print()
c2, t2 = evaluate(ambiguous_cases, "TẬP MƠ HỒ (12 câu)")
